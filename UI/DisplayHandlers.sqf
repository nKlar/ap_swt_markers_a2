swt_markers_onLoad = compile preprocessFileLineNumbers '\swt_markers_a2\UI\onLoad.sqf';
swt_markers_infoAnim = compile preprocessfilelinenumbers '\swt_markers_a2\UI\RscDisplayInsertMarker.sqf';
