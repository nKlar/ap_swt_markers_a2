////////////////////////////////////////////////////////////////////
//DeRap: swt_markers_a2\config.bin
//Produced from mikero's Dos Tools Dll version 6.44
//'now' is Sat Oct 21 12:31:23 2017 : 'file' last modified on Sat Sep 19 19:57:31 2015
...
{
	class swt_markers_a2
	{
		Init = "call compile preProcessFileLineNumbers '\swt_markers_a2\fn_init.sqf'";
	};
};
class RscListBox;
...
class swt_RscCombo: RscCombo
{
	...
	arrowEmpty = "\swt_markers_a2\arrow_combo_ca.paa";
	arrowFull = "\swt_markers_a2\arrow_combo_active_ca.paa";
	wholeHeight = 0.45;
	colorActive[] = {1,0,0,1};
	colorDisabled[] = {1,1,1,0.25};
...
class swt_RscDisplayInsertMarker
{
	...
	class controls
	{
		...
		{
			idc = 900;
			text = "\swt_markers_a2\icon_config_ca.paa";
			x = 0;
			y = 0;
		...
		class swt_RscControlsGroup_adv: swt_RscControlsGroup
		{
			...
			class controls
			{
				...
				class text_show_info: swt_RscStructuredText_sett
				{
					idc = 242;
					text = "INFO";
					y = "(2*0.9) * ((((safezoneW/safezoneH) min 1.2)/1.2)/25)";
